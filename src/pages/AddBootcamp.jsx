        ...
        <section className="container mt-5">
            ...
            <form action="manage-bootcamp.html">
                    ...
                    <div className="col-md-6">
                        <div className="card bg-white py-2 px-4">
                            <div className="card-body">
                                ...
                                <div className="form-group">
                                    <label>Careers</label>
                                    <select name="careers" className="custom-select" multiple defaultValue={['all']}>
                                        <option value="all">Select all that apply</option>
                ...
                <div className="form-group">
                    ...
                    />
                    <span onClick={() => history.goBack()} className="btn btn-danger btn-block mb-4">Cancel</span>
                </div>
            </form>
        </section>
...
AddBootcamp = withRouter(AddBootcamp);
export { AddBootcamp }